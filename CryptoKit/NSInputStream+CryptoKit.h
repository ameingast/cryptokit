...
/**
 * Encrypt the contents of the NSInputStream instance 
 * using a given password and write the encrypted 
 * result to outputStream.
 * 
 * This method works especially well for large amounts of 
 * streamable data.
 *
 * @warning     This method will block the current thread
 *              until all data from the inputStream instance
...
/**
 * Decrypt the contents of the NSInputStream instance
 * using a given password and write the decrypted
 * result to outputStream.
 *
 * This method works especially well for large amounts of
 * streamable data.
